...
//snow variables (line no 36)
//snow logic (line no 127)
//snow fall (line no 2774)
//white red trees (line no 10644)
//winter hills (line no 11235)
//snow clouds (line no 11300)
/*
case 's':
    snowfall=true;
    glutPostRedisplay();
